...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addComponent(jLabelImage, javax.swing.GroupLayout.DEFAULT_SIZE, 136, Short.MAX_VALUE)
        );
        jPanel7Layout.setVerticalGroup(
            jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabelImage, javax.swing.GroupLayout.DEFAULT_SIZE, 105, Short.MAX_VALUE)
        );
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student's ID", "Name", "Date Of Birth", "Gender", "Email", "Phone", "Father's Name", "Mother's Name", "Address Line 1", "Address Line 2", "Image path"
            }
        ) {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            jTable1.getColumnModel().getColumn(0).setHeaderValue("Student's ID");
            ...
            jTable1.getColumnModel().getColumn(6).setHeaderValue("Father's Name");
        ...
        jButton9.setBackground(new java.awt.Color(195, 47, 47));
        ...
        jComboBox6.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "C++ Programming", "Ruby Programming", "Go Programming", "Python Programming", "Java Programming", "JavaScript Programming", "Swift Programming", "Kotlin Programming" }));

        jComboBox7.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Principle of computer component", "Cyber Security", "Web Programming", "Design User Interface", "Software Testing and Inspection", "Mobile App Development", "Web Service", "Statistic" }));

        jComboBox8.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Aljabar Linier", "SQL Databse", "Software Testing", "OS Linux", "Data Science", "Big Data I", "Big Data II", "Artificial Intelligence" }));

        jComboBox9.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Data Analyst", "Computer Network", "React JS", "Principle of Operating System", "Computer Science", "Data structures & Algorithms", "Digital Image Processing", "Laravel" }));
        ...
        jComboBox10.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cloud Computing", "Algorithms Analysis and Design", "Machine Learning", "Deep Learning", "IT Project Management", "Spring Java", "Frontend WEB", "Backend WEB" }));
        ...
        jPanel16Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(searchField1, javax.swing.GroupLayout.PREFERRED_SIZE, 316, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(31, 31, 31)
        ...
        jButton18.setBackground(new java.awt.Color(195, 47, 47));
                    ...
                    .addGroup(jPanel14Layout.createSequentialGroup()
                        .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(jTextField15, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 296, Short.MAX_VALUE)
                                .addComponent(jTextField11, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 296, Short.MAX_VALUE)))
                        .addGap(18, 18, 18)
                        ...
                        .addGroup(jPanel20Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel20Layout.createSequentialGroup()
                                .addGroup(jPanel20Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(jTextCourse3, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 255, Short.MAX_VALUE)
                                ...
                                .addGap(12, 12, 12)
                                .addGroup(jPanel20Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jTextScore4, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 73, Short.MAX_VALUE)
        ...
        jLabel38.setFont(new java.awt.Font("Arial", 1, 25)); // NOI18N
        ...
        jPanel24Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel24Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(searchField2, javax.swing.GroupLayout.PREFERRED_SIZE, 316, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(31, 31, 31)
        ...
        jButton27.setBackground(new java.awt.Color(195, 47, 47));
        ...
        jPanel21Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel21Layout.createSequentialGroup()
                ...
                .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel21Layout.createSequentialGroup()
                        .addComponent(jTextField25, javax.swing.GroupLayout.PREFERRED_SIZE, 296, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        jButton36.setBackground(new java.awt.Color(195, 47, 47));
        ...
        if (isEmptyStudent()) {
            if (!student.isEmailExist(jTextField3.getText())) {
                if (!student.isPhoneExist(jTextField4.getText())) {
                    ...
                    JOptionPane.showMessageDialog(this, "Sorry, this phone number is already exists!");
                }

            } else {
                JOptionPane.showMessageDialog(this, "Sorry, this email is already exists!");
            }
    ...
    public boolean check() {
        ...
        if (newEmail.equals(oldEmail) && newPhone.equals(oldPhone)) {
            ...
            if (!newEmail.equals(oldEmail)) {
                ...
                if (x) {
                    JOptionPane.showMessageDialog(this, "Sorry! this email already exists");
                }
                return x;
            }
            if (!newPhone.equals(oldPhone)) {
                ...
                if (x) {
                    JOptionPane.showMessageDialog(this, "Sorry! this phone number already exists");
                }
                return x;
            }
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        imagePath = path;
        // get image path and called imageAdjust method canvert path to imageIcon
        jLabelImage.setIcon(imageAdjust(path, null));
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        if (jTextField10.getText().isEmpty()) {
            ...
            if (course.getId(id)) {
                jComboBox5.removeAllItems();
                int program = course.countProgram(id);
                if (program >= 0) {
                    for (int i = 1; i <= program + 1; i++) {
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        if (jTextField12.getText().isEmpty() || jComboBox5.getItemCount() == 0) {
            JOptionPane.showMessageDialog(this, "Student id or program session is missing");
        } else {
            int id = course.getMax();
            int sid = Integer.parseInt(jTextField12.getText());
            int programNo = Integer.parseInt(jComboBox5.getSelectedItem().toString());
            ...
            if (course.isProgramExist(sid, programNo)) {
                JOptionPane.showMessageDialog(this, "This student has already taken program" + programNo);
            } else {
                        ...
                        if (course.isCourseExist(sid, "course3", course3)) {
                            ...
                            if (course.isCourseExist(sid, "course4", course4)) {
                                ...
                                if (course.isCourseExist(sid, "course5", course5)) {
                                    ...
                                    course.insert(id, sid, programNo, course1, course2, course3, course4, course5);
                                    jTable2.setModel(new DefaultTableModel(null, new Object[]{"ID", "Student ID", "Program", "Course1", "Course2", "Course3", "Course4", "Course5"}));
                                    course.getCourseValue(jTable2, "");
                                    clearCourse();
                                }
                            }
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        if (jTextField11.getText().isEmpty() || jTextField15.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Student's ID or program number is missing!");
        } else {
            int sid = Integer.parseInt(jTextField11.getText());
            int proNo = Integer.parseInt(jTextField15.getText());
            score.getDetails(sid, proNo);
        }
    ...
    private void jButton22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton22ActionPerformed
        if (!jTextField13.getText().isEmpty()) {
            if (!score.isIdExist(Integer.parseInt(jTextField14.getText()))) {
                ...
                int programNo = Integer.parseInt(jTextField16.getText());
                if (!score.isIdProgramNoExist(sid, programNo)) {
                    if (isNumeric(jTextScore1.getText()) && isNumeric(jTextScore2.getText())
                        ...
                        score.insert(id, sid, programNo, course1, course2, course3, course4, course5, score1, score2, score3, score4, score5, Double.parseDouble(nf.format(average)));
                        jTable3.setModel(new DefaultTableModel(null, new Object[]{"ID", "Student ID", "Program", "Course1", "Score1", "Course2", "Score2", "Course3", "Score3", "Course4", "Score4", "Course5", "Score5", "Average"}));
                        score.getScoreValue(jTable3, "");
                        clearScore();
                    }
                } else {
                    JOptionPane.showMessageDialog(this, "Program " + programNo + " Score already added!");
                }
            } else {
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        if (jTextField25.getText().isEmpty()) {
            ...
            if (marksSheet.isIdExist(sid)) {
                jTable4.setModel(new DefaultTableModel(null, new Object[]{"ID", "Student ID", "Program", "Course1", "Score1", "Course2", "Score2", "Course3", "Score3", "Course4", "Score4", "Course5", "Score5", "Average"}));
                marksSheet.getScoreValue(jTable4, sid);
                String cgpa = String.valueOf(String.format("%.2f", marksSheet.getCGPA(sid)));
                jLabel28.setText("CGPA: " + cgpa);
            } else {
    ...
    private void jButton34ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton34ActionPerformed
        try {
            MessageFormat header = new MessageFormat("Marks Sheet    Student's ID : " + jTextField25.getText() + "    " + jLabel28.getText());
            MessageFormat footer = new MessageFormat("Page{0,number,integer}");
